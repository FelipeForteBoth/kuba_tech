...
const create = (tenantId, data) =>
  db.one(
    `INSERT INTO service_orders
       (tenant_id, customer_id, device_id, technician_id, opening_date, problem_description, status, created_by)
  ...
  db.one(
    `UPDATE service_orders
        SET customer_id = $3, device_id = $4, technician_id = $5, opening_date = $6,
            problem_description = $7, solution = $8, status = $9
...
module.exports = { list, findById, create, update, updateProgress, remove, statusSummary };
